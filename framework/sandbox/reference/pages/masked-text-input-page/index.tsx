...
const MaskedTextInputPage = () => (
  <ReferencePage data={ {
    tags: {},
    filePath: '/Users/sebastian.delgado/Documents/Programmering/Mediatool/northlight/framework/lib/components/text-field/masked-text-input.tsx',
    description: '',
    displayName: 'MaskedTextInput',
    methods: [],
    props: {
      focusBorderColor: {
        defaultValue: null,
...
export default MaskedTextInputPage
