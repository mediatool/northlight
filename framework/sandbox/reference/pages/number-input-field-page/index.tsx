...
const NumberInputFieldPage = () => (
  <ReferencePage data={ {
    tags: {},
    filePath: '/Users/sebastian.delgado/Documents/Programmering/Mediatool/northlight/framework/lib/components/number-input/number-input-field.tsx',
    description: '',
    displayName: 'NumberInputField',
    methods: [],
    props: {
      pattern: {
        defaultValue: {
