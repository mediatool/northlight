  ...
  const SelectPage = () => (
    <ReferencePage data={{
  "tags": {
    "see": "Blinker *\nSearchBar *\nNew *\n{@link https://northlight.dev/reference/select}",
  ...
  "filePath": "/Users/sebastian.delgado/Documents/Programmering/Mediatool/northlight/framework/lib/components/select/select.tsx",
  "description": "Select component that provides a customizable and accessible select input.\nIt is built on top of Chakra UI and Chakra React Select components.",
  "displayName": "Select",
  "methods": [],
  "props": {
    "value": {
      "defaultValue": null,
      "description": "Whatever is currently selected by the select will be controlled by value prop",
      "name": "value",
      "parent": {
        "fileName": "framework/lib/components/select/types.ts",
        "name": "SelectProps"
      },
      "declarations": [
        {
    ...
    "onChange": {
      "defaultValue": null,
      "description": "Take a look at the second argument, the event, for info as to which specific elmeent was added",
      "name": "onChange",
      "parent": {
        "fileName": "framework/lib/components/select/types.ts",
        "name": "SelectProps"
      ...
      "required": false,
      "type": {
        "name": "(val: any, event: ActionMeta<T>) => void"
      }
    },
    "onAdd": {
      "defaultValue": null,
    ...
    "loadingList": {
      ...
      "type": {
        "name": "enum",
        "raw": "ComponentType<MenuListProps<T, boolean, GroupBase<T>>>",
        "value": [
          {
            "value": "ComponentClass<MenuListProps<T, boolean, GroupBase<T>>, any>",
            "description": "",
            "fullComment": "",
            "tags": {}
          },
          {
            "value": "FunctionComponent<MenuListProps<T, boolean, GroupBase<T>>>",
            "description": "",
            "fullComment": "",
            "tags": {}
          }
    ...
    "icon": {
      "defaultValue": null,
      "description": "Custom icon that will be put to the faremost right of the component",
      "name": "icon",
      "parent": {
        "fileName": "framework/lib/components/select/types.ts",
        "name": "SelectProps"
