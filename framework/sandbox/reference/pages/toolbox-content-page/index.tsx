...
const ToolboxContentPage = () => (
  <ReferencePage data={ {
    tags: {},
    filePath: '/Users/sebastian.delgado/Documents/Programmering/Mediatool/northlight/framework/lib/components/toolbox/toolbox-content.tsx',
    description: '',
    displayName: 'ToolboxContent',
    methods: [],
    props: {
      align: {
        defaultValue: null,
...
export default ToolboxContentPage
