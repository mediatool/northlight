...
const ToolboxFooterPage = () => (
  <ReferencePage data={ {
    tags: {},
    filePath: '/Users/sebastian.delgado/Documents/Programmering/Mediatool/northlight/framework/lib/components/toolbox/toolbox-footer.tsx',
    description: '',
    displayName: 'ToolboxFooter',
    methods: [],
    props: {
      align: {
        defaultValue: null,
...
export default ToolboxFooterPage
