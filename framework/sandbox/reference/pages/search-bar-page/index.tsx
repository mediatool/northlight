...
const SearchBarPage = () => (
  <ReferencePage data={ {
    tags: {},
    filePath: '/Users/sebastian.delgado/Documents/Programmering/Mediatool/northlight/framework/lib/components/search-bar/search-bar.tsx',
    description: '',
    ...
    props: {
      value: {
        ...
        type: {
          name: 'enum',
          raw: 'SearchBarOptionType | SearchBarOptionType[]',
          value: [
            {
      ...
      onChange: {
        ...
        required: false,
        type: {
          name: '(val: any, event: ActionMeta<SearchBarOptionType>) => void',
        },
      },
      onAdd: {
        defaultValue: null,
      ...
      customOption: {
        ...
        required: false,
        type: {
          name: '(props: SearchBarOptionType) => Element',
        },
      },
      customTag: {
        defaultValue: {
      ...
      loadOptions: {
        ...
        required: false,
        type: {
          name: '(query: string) => Promise<SearchBarOptionType[]>',
        },
      },
      onSearchInputChange: {
        defaultValue: null,
      ...
      defaultValue: {
        ...
        type: {
          name: 'enum',
          raw: 'PropsValue<SearchBarOptionType>',
          value: [
            {
              value: 'SearchBarOptionType',
              description: '',
            ...
            {
              value: 'MultiValue<SearchBarOptionType>',
              description: '',
              fullComment: '',
              tags: {},
            },
      ...
      components: {
        ...
        required: false,
        type: {
          name: 'Partial<SelectComponents<SearchBarOptionType, boolean, GroupBase<SearchBarOptionType>>>',
        },
      },
      name: {
        defaultValue: null,
      ...
      ariaLiveMessages: {
        ...
        required: false,
        type: {
          name: 'AriaLiveMessages<SearchBarOptionType, boolean, GroupBase<SearchBarOptionType>>',
        },
      },
      ...
      classNames: {
        ...
        required: false,
        type: {
          name: 'ClassNamesConfig<SearchBarOptionType, boolean, GroupBase<SearchBarOptionType>>',
        },
      },
      closeMenuOnSelect: {
        defaultValue: {
      ...
      filterOption: {
        ...
        required: false,
        type: {
          name: '(option: FilterOptionOption<SearchBarOptionType>, inputValue: string) => boolean',
        },
      },
      formatGroupLabel: {
        defaultValue: null,
        ...
        required: false,
        type: {
          name: '(group: GroupBase<SearchBarOptionType>) => ReactNode',
        },
      },
      formatOptionLabel: {
        defaultValue: null,
        ...
        required: false,
        type: {
          name: '(data: SearchBarOptionType, formatOptionLabelMeta: FormatOptionLabelMeta<SearchBarOptionType>) => ReactNode',
        },
      },
      getOptionLabel: {
        defaultValue: null,
        ...
        required: false,
        type: {
          name: 'GetOptionLabel<SearchBarOptionType>',
        },
      },
      getOptionValue: {
        defaultValue: null,
        ...
        required: false,
        type: {
          name: 'GetOptionValue<SearchBarOptionType>',
        },
      },
      hideSelectedOptions: {
        defaultValue: null,
      ...
      isOptionDisabled: {
        ...
        required: false,
        type: {
          name: '(option: SearchBarOptionType, selectValue: Options<SearchBarOptionType>) => boolean',
        },
      },
      isOptionSelected: {
        defaultValue: null,
      ...
      options: {
        ...
        required: false,
        type: {
          name: 'OptionsOrGroups<SearchBarOptionType, GroupBase<SearchBarOptionType>>',
        },
      },
      pageSize: {
        defaultValue: null,
      ...
      styles: {
        ...
        required: false,
        type: {
          name: 'StylesConfig<SearchBarOptionType, boolean, GroupBase<SearchBarOptionType>>',
        },
      },
      tabSelectsValue: {
        defaultValue: null,
      ...
      chakraStyles: {
        ...
        required: false,
        type: {
          name: 'ChakraStylesConfig<SearchBarOptionType, boolean, GroupBase<SearchBarOptionType>>',
        },
      },
      useBasicStyles: {
        defaultValue: null,
