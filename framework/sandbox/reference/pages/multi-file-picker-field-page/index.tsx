...
const MultiFilePickerFieldPage = () => (
  <ReferencePage data={ {
    tags: {},
    filePath: '/Users/sebastian.delgado/Documents/Programmering/Mediatool/northlight/framework/lib/components/file-picker/multi-file-picker-field.tsx',
    description: '',
    displayName: 'MultiFilePickerField',
    methods: [],
    props: {
      onChange: {
        defaultValue: null,
        ...
        parent: {
          ...
          name: 'MultiFilePickerFieldProps',
        },
        declarations: [
          {
            fileName: 'framework/lib/components/file-picker/types.ts',
...
export default MultiFilePickerFieldPage
