...
export const RangeCalendar = (props: RangeCalendarProps) => {
  ...
  const calendarOneState = useCalendarState({
    ...
    minValue,
    maxValue: value && value.end ? value.end : undefined,
    onChange: (newVal) => {
      setRange({
        end: value && value.end ? value.end : newVal,
        start: newVal,
      })
    },
    locale,
  ...
  const calendarTwoState = useCalendarState({
    ...
    minValue: value && value.start ? value.start : undefined,
    maxValue,
    onChange: (newVal) => {
      setRange({
        start: value && value.end ? value.start : newVal,
        end: newVal,
      })
    },
    locale,
