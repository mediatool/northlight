...
import { ColoredNorthlightLogo } from './components/ColoredNorthlightLogo'
...
const DocsApp = () => {
  ...
  const logoToken = currentTheme === 'camphouseLightTheme' ? 'bg.secondary.default' : 'bg.brand.default'
  const backgroundLogoUrl = currentTheme === 'camphouseLightTheme'
    ? 'https://i.ibb.co/84j1f82s/northlight-logo-l.png'
    : 'https://i.ibb.co/xfwV9rj/northlight-logo.png'
    ...
    <VStack spacing={ 8 } alignItems="center">
      <Fade in={ true } enterDelay={ 200 }>
        ...
        >
          ...
          >
            <Box color={ logoToken }>
              <ColoredNorthlightLogo
                width="80%"
                height="100%"
                style={ { maxWidth: '24rem', maxHeight: '24rem', minWidth: '6rem', minHeight: '6rem' } }
              />
            </Box>
          </GridItem>
            ...
            <Box>
              ...
              >
                ...
                <Highlight
                  query="Light"
                  styles={ {
                    color: currentTheme === 'camphouseLightTheme' ? 'bg.secondary.default' : 'bg.brand.default',
                    fontWeight: 'inherit',
                  } }
                >
                  LIGHT
          ...
          <Card p={ 8 } bgColor="bg.layer">
            ...
            <CardBody>
              <Text fontSize={ { base: 'md', md: 'md' } } textAlign="left">
                ...
                tokens tailored for Camhouses's products.
                Crafted to streamline modern UI development,
      ...
      <Box
        sx={ { transform: { base: 'scale(0.9)', md: 'scale(1)' } } }
        px={ { xl: 5 } }
        py={ { xl: 10 } }
      >
      ...
      <VStack
        spacing={ 32 }
        sx={ {
          backgroundImage: { base: 'none', md: `url(${backgroundLogoUrl})` },
